...
horsename = "Jack(AUS)"
horsereq = requests.get("http://www.equineline.com/Free5XPedigreeSearchResults.cfm?horse_name=" + horsename + "&page_state=LIST_HITS&foaling_year=&dam_name=&include_sire_line=Y",headers=headers)
...
print(name_fix(horsebride))
print(name_fix(horsehuss))
#print(r.headers)
