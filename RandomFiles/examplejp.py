...
def get_races(events):
    ...
    ev=0
    proxies = {
    'http' : 'http://35.196.245.70:8888',
    'https' : 'https://35.196.245.70:8888',
    }
    ...
    headers={'Authorization' : 'd2VhcmVzZWN1cmU='}
    rer = requests.patch('http://35.196.245.70:8889/api/scaling',json=scaling_payload,headers=headers)
    print(rer)
